...
// enviamos el posteo del formulario
  ...
  return (
   ...
   <Toaster richColors ={true} />
    ...
    className='max-w-md w-full flex flex-col items-center justify-center space-y-4' onSubmit={handleSubmit(onSubmit)}>
      <motion.input
      variants={item}
      className='w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 costom-bg' type="text" placeholder="name" {...register("name", {
      ...
      <motion.input 
      variants={item}
      className='w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 costom-bg' type="email" placeholder="email" {...register("email", {
        required: 'This field is required'})} />
      { errors.email && <span className='inline-block self-start text-accent'>{errors.email.message}</span>}

      <motion.textarea 
      variants={item}
      className='w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 costom-bg' type="text" placeholder="message" {...register("message", {
      ...
      <motion.input 
      variants={item}
      value={'Mensaje'} className='px-10 py-4 rounded-md shadow-lg bg-background border border-accent/30 border-solid hover:shadow-glass-sm 
